...
### Receiver Flow
![Receiver Flow Diagram](./public/cypherdrop_receiver_flow.svg)
...
Please note our branching strategy: **all pull requests must be targeted against the `dev` branch**, not `main`.

1. Fork the Project
2. Create your Feature Branch (`git checkout -b feature/amazing-feature`)
3. Commit your Changes (`git commit -m 'feat: add some amazing feature'`)
4. Push to the Branch (`git push origin feature/amazing-feature`)
5. Open a Pull Request pointing to the `dev` branch
